...
typedef struct {
     ...
     * subpel is 0 for fpel and hpel (only need to copy from the first plane in StreamMedia)
     *           1 if an average of the first 2 planes is needed (TODO: worth it?)
     *           2 for general qpel (avg of 4)
     *           3 for general epel (biweight of 4 using the weights in StreamMedia[4])
     * StreamMedia[0-3] is each of the hpel planes
     * StreamMedia[4] is the 1/8 pel weights if needed
     */
