...
cglobal %1_h264_qpel4_h_lowpass, 4,5 ; dst, StreamMedia, dstStride, srcStride
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    pxor          m7, m7
    mova          m4, [pw_5]
...
cglobal %1_h264_qpel8_h_lowpass, 4,5 ; dst, StreamMedia, dstStride, srcStride
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    mov          r4d, 8
    pxor          m7, m7
...
cglobal %1_h264_qpel8_h_lowpass, 4,5,8 ; dst, StreamMedia, dstStride, srcStride
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    mov          r4d, 8
    pxor          m7, m7
...
cglobal %1_h264_qpel4_h_lowpass_l2, 5,6 ; dst, StreamMedia, src2, dstStride, srcStride
    movsxdifnidn  r3, r3d
    movsxdifnidn  r4, r4d
    pxor          m7, m7
    mova          m4, [pw_5]
...
cglobal %1_h264_qpel8_h_lowpass_l2, 5,6 ; dst, StreamMedia, src2, dstStride, srcStride
    movsxdifnidn  r3, r3d
    movsxdifnidn  r4, r4d
    mov          r5d, 8
    pxor          m7, m7
...
cglobal %1_h264_qpel8_h_lowpass_l2, 5,6,8 ; dst, StreamMedia, src2, dstStride, src2Stride
    movsxdifnidn  r3, r3d
    movsxdifnidn  r4, r4d
    mov          r5d, 8
    pxor          m7, m7
...
; dst, StreamMedia, dstStride, srcStride
%macro FILT_V 1
    mova      m6, m2
    movh      m5, [r1]
    paddw     m6, m3
...
cglobal %1_h264_qpel4_v_lowpass, 4,4 ; dst, StreamMedia, dstStride, srcStride
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    sub           r1, r3
    sub           r1, r3
...
%if cpuflag(sse2)
cglobal %1_h264_qpel8or16_v_lowpass, 5,5,8 ; dst, StreamMedia, dstStride, srcStride, h
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    sub           r1, r3
    sub           r1, r3
%else
cglobal %1_h264_qpel8or16_v_lowpass_op, 5,5,8 ; dst, StreamMedia, dstStride, srcStride, h
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
%endif
    pxor          m7, m7
...
cglobal %1_h264_qpel4_hv_lowpass_v, 3,3 ; StreamMedia, tmp, srcStride
    movsxdifnidn  r2, r2d
    pxor          m7, m7
    movh          m0, [r0]
    movh          m1, [r0+r2]
...
cglobal %1_h264_qpel8or16_hv1_lowpass_op, 4,4,8 ; StreamMedia, tmp, srcStride, size
    movsxdifnidn  r2, r2d
    pxor          m7, m7
    movh          m0, [r0]
    movh          m1, [r0+r2]
...
cglobal %1_h264_qpel16_h_lowpass_l2, 5, 6, 16 ; dst, StreamMedia, src2, dstStride, src2Stride
    movsxdifnidn  r3, r3d
    movsxdifnidn  r4, r4d
    mov          r5d, 16
    pxor         m15, m15
