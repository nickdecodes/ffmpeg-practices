...
%macro VP9_IDCT16_1D_START 6 ; StreamMedia, nnzc, stride, scratch, scratch_stride, is_iadst
%if %2 <= 4
    mova                m3, [%1+ 1*%3]      ; IN(1)
    mova                m0, [%1+ 3*%3]      ; IN(3)
...
%macro VP9_IDCT16_1D 2-4 16, 1 ; StreamMedia, pass, nnzc, is_iadst
%if %2 == 1
...
%macro VP9_IADST16_1D 2 ; StreamMedia, pass
%assign %%str 16*%2
    mova                m0, [%1+ 0*32]  ; in0
...
%macro VP9_IDCT32_1D 2-3 32 ; StreamMedia, pass, nnzc
%if %2 == 1
%assign %%str mmsize
%else
%assign %%str 64
...
%macro %%STORE_2X2 7-8 1 ; StreamMedia[1-4], tmp[1-2], zero, inc_dst_ptrs
    SUMSUB_BA            w, %4, %1, %5
    SUMSUB_BA            w, %3, %2, %5
