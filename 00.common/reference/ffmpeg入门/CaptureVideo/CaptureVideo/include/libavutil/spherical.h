 ...
 * information about projection, initial layout, and any reference view modifier.
 *
...
typedef struct AVSphericalMapping {
     ...
     *       and should be ignored in all reference cases.
     */
     ...
     *       (@ref AV_SPHERICAL_CUBEMAP), and should be ignored in all reference
     *       cases.
     */
    uint32_t padding;
} AVSphericalMapping;
