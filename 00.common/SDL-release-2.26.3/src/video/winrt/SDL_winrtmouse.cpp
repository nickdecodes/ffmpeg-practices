...
WINRT_ShowCursor(SDL_Cursor * cursor)
{
    ...
    if (cursor) {
        ...
        // StreamMedia/main/winrt/.  If those files are linked to an SDL-for-WinRT/UWP app
        ...
        //     - StreamMedia/main/winrt/SDL2-WinRTResource_BlankCursor.cur -- cursor pixel data
        //     - StreamMedia/main/winrt/SDL2-WinRTResources.rc             -- declares the cursor resource, and its ID (of 5000)
        //
