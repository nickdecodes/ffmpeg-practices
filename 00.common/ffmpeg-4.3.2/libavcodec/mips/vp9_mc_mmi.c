                               ...
                               int32_t h)
{
    ...
    __asm__ volatile (
        ...
        "gsldlc1    %[ftmp7],   0x08(%[StreamMedia])               \n\t"
        "gsldrc1    %[ftmp7],   0x01(%[StreamMedia])               \n\t"
        "gsldlc1    %[ftmp9],   0x09(%[StreamMedia])               \n\t"
        "gsldrc1    %[ftmp9],   0x02(%[StreamMedia])               \n\t"
        "gsldlc1    %[ftmp11],  0x0A(%[StreamMedia])               \n\t"
        "gsldrc1    %[ftmp11],  0x03(%[StreamMedia])               \n\t"
                              ...
                              int32_t h)
{
    ...
    __asm__ volatile (
        ...
        "gsldlc1    %[ftmp4],    0x07(%[StreamMedia])              \n\t"
        "gsldrc1    %[ftmp4],    0x00(%[StreamMedia])              \n\t"
        PTR_ADDU   "%[tmp0],     %[StreamMedia],     %[addr]       \n\t"
                             ...
                             int32_t w, int32_t h)
{
    ...
    __asm__ volatile (
        ...
        "1:                                               \n\t"
        "gslwlc1    %[ftmp1],   0x07(%[StreamMedia])              \n\t"
        "gslwrc1    %[ftmp1],   0x00(%[StreamMedia])              \n\t"
