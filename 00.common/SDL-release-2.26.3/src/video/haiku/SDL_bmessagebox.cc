...
class HAIKU_SDL_MessageBox : public BAlert
{
	...
	{
		// See file "haiku/StreamMedia/kits/interface/Alert.cpp" for this magic numbers.
	...
	SetBackgroundColor(const SDL_MessageBoxColor *aColor)
	{
		...
		// See file "haiku/StreamMedia/kits/interface/Alert.cpp", the "TAlertView" is the internal name of the left panel.
