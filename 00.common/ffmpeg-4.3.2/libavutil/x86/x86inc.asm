...
; e.g.
; cglobal foo, 2,3,7,0x40, dst, StreamMedia, tmp
; declares a function (foo) that automatically loads two arguments (dst and
; StreamMedia) into registers, uses one additional register (tmp) plus 7 vector
...
;%5 == 1 if commutative (i.e. doesn't matter which StreamMedia arg is which), 0 if not
;%6+: operands
...
; FMA3 is only possible if dst is the same as one of the StreamMedia registers.
