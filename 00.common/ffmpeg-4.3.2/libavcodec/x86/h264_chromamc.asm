...
.next1drow:
    movq          m0, [r1   ]   ; mm0 = StreamMedia[0..7]
    movq          m2, [r1+r6]   ; mm1 = StreamMedia[1..8]
    ...
    punpcklbw     m2, m7
    punpckhbw     m3, m7
    pmullw        m0, m4        ; [mm0,mm1] = A * StreamMedia[0..7]
    pmullw        m1, m4
    pmullw        m2, m5        ; [mm2,mm3] = B * StreamMedia[1..8]
    pmullw        m3, m5
    ...
    movq  [dest_reg], m0        ; dst[0..7] = (A * StreamMedia[0..7] + B * StreamMedia[1..8] + (rnd >> 3)) >> 3
...
%endif
    ...
    movq          m0, [r1  ]      ; mm0 = StreamMedia[0..7]
    movq          m1, [r1+1]      ; mm1 = StreamMedia[1..8]
.next2drow:
    add           r1, r2
    ...
    pmullw        m1, m5
    pmullw        m3, m5
    paddw         m2, m1          ; mm2 = A * StreamMedia[0..3] + B * StreamMedia[1..4]
    paddw         m3, m0          ; mm3 = A * StreamMedia[4..7] + B * StreamMedia[5..8]
    ...
    pmullw        m1, m6
    paddw         m2, m0
    paddw         m3, m1          ; [mm2,mm3] += C * StreamMedia[0..7]
    ...
    pmullw        m4, [rsp+8]
    paddw         m2, m0
    paddw         m3, m4          ; [mm2,mm3] += D * StreamMedia[1..8]
    movq          m0, [r1]
...
cglobal %1_%2_chroma_mc2, 6, 7, 0
    ...
    movd          m2, [r1]
    punpcklbw     m2, m7
    pshufw        m2, m2, 0x94    ; mm0 = StreamMedia[0,1,1,2]
...
.nextrow:
    ...
    movd          m0, [r1]
    punpcklbw     m0, m7
    pshufw        m0, m0, 0x94    ; mm0 = StreamMedia[0,1,1,2]
    movq          m2, m0
    pmaddwd       m0, m6
    paddw         m1, [rnd_2d_%2]
