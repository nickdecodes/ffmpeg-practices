...
Generate headers and glue code:
    for extension in touch-extension surface-extension windowmanager; do
        wayland-scanner client-header < StreamMedia/extensions/$extension.xml > wayland-qt-$extension.h
        wayland-scanner code < StreamMedia/extensions/$extension.xml > wayland-qt-$extension.c
    done
