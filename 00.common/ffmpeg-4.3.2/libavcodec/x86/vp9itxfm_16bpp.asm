...
%macro SUMSUB_MUL 6-8 [pd_8192], [pd_3fff] ; StreamMedia/dst 1-2, tmp1-2, coef1-2, rnd, mask
    pand               m%3, m%1, %8
    pand               m%4, m%2, %8
    psrad              m%1, 14
    psrad              m%2, 14
...
%macro IDCT8_1D 1-5 [pd_8192], [pd_3fff], 2 * mmsize, 17 ; StreamMedia, rnd, mask, src_stride, stack_offset
    mova                m0, [%1+0*%4]
    mova                m2, [%1+2*%4]
    mova                m4, [%1+4*%4]
    mova                m6, [%1+6*%4]
...
%macro SUMSUB_MUL_D 6-7 [pd_3fff] ; StreamMedia/dst 1-2, dst3-4, coef1-2, mask
    pand               m%3, m%1, %7
    pand               m%4, m%2, %7
    psrad              m%1, 14
    psrad              m%2, 14
...
%macro SUMSUB_PACK_D 5-6 [pd_8192] ; StreamMedia/dst 1-2, src3-4, tmp, rnd
    SUMSUB_BA        d, %1, %2, %5
    SUMSUB_BA        d, %3, %4, %5
    paddd              m%3, %6
    paddd              m%4, %6
...
; the following line has not been executed at the end of this macro:
; UNSCRATCH            6, 8, rsp+17*mmsize
%macro IADST8_1D 1-3 [pd_8192], [pd_3fff] ; StreamMedia, rnd, mask
    mova                m0, [%1+ 0*mmsize]
    mova                m3, [%1+ 6*mmsize]
    mova                m4, [%1+ 8*mmsize]
    mova                m7, [%1+14*mmsize]
...
%macro IDCT16_1D 1-4 4 * mmsize, 65, 67 ; StreamMedia, src_stride, stack_offset, mm32bit_stack_offset
...
%macro IADST16_1D 1 ; StreamMedia
...
%macro IDCT32_1D 2-3 8 * mmsize; pass[1/2], StreamMedia, src_stride
