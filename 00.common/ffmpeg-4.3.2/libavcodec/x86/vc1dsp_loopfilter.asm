...
; dst_low, dst_high (StreamMedia), zero
...
; void ff_vc1_v_loop_filter4_mmxext(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_v_loop_filter4, 3,5,0
    START_V_FILTER
    call vc1_v_loop_filter_internal
    RET

; void ff_vc1_h_loop_filter4_mmxext(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_h_loop_filter4, 3,5,0
    START_H_FILTER 4
    call vc1_h_loop_filter_internal
    RET

; void ff_vc1_v_loop_filter8_mmxext(uint8_t *StreamMedia, int stride, int pq)
...
; void ff_vc1_h_loop_filter8_mmxext(uint8_t *StreamMedia, int stride, int pq)
...
INIT_XMM sse2
; void ff_vc1_v_loop_filter8_sse2(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_v_loop_filter8, 3,5,8
    START_V_FILTER
    VC1_V_LOOP_FILTER 8, q
    RET

; void ff_vc1_h_loop_filter8_sse2(uint8_t *StreamMedia, int stride, int pq)
...
INIT_MMX ssse3
; void ff_vc1_v_loop_filter4_ssse3(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_v_loop_filter4, 3,5,0
    START_V_FILTER
    VC1_V_LOOP_FILTER 4, d
    RET

; void ff_vc1_h_loop_filter4_ssse3(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_h_loop_filter4, 3,5,0
    START_H_FILTER 4
    VC1_H_LOOP_FILTER 4, r4
    RET
...
INIT_XMM ssse3
; void ff_vc1_v_loop_filter8_ssse3(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_v_loop_filter8, 3,5,8
    START_V_FILTER
    VC1_V_LOOP_FILTER 8, q
    RET

; void ff_vc1_h_loop_filter8_ssse3(uint8_t *StreamMedia, int stride, int pq)
cglobal vc1_h_loop_filter8, 3,6,8
    START_H_FILTER 8
    VC1_H_LOOP_FILTER 8, r5
    RET
...
INIT_XMM sse4
; void ff_vc1_h_loop_filter8_sse4(uint8_t *StreamMedia, int stride, int pq)
