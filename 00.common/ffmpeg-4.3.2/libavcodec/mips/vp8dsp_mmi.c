...
#if 0
#define FILTER_6TAP(StreamMedia, F, stride)                                           \
    cm[(F[2] * StreamMedia[x + 0 * stride] - F[1] * StreamMedia[x - 1 * stride] +             \
        F[0] * StreamMedia[x - 2 * stride] + F[3] * StreamMedia[x + 1 * stride] -             \
        F[4] * StreamMedia[x + 2 * stride] + F[5] * StreamMedia[x + 3 * stride] + 64) >> 7]

#define FILTER_4TAP(StreamMedia, F, stride)                                           \
    cm[(F[2] * StreamMedia[x + 0 * stride] - F[1] * StreamMedia[x - 1 * stride] +             \
        F[3] * StreamMedia[x + 1 * stride] - F[4] * StreamMedia[x + 2 * stride] + 64) >> 7]
        ...
        ptrdiff_t srcstride, int h, int x, int y)
{
    ...
    __asm__ volatile (
        "1:                                                         \n\t"
        PTR_ADDU   "%[addr0],   %[StreamMedia],         %[srcstride]        \n\t"
        MMI_ULDC1(%[ftmp0], %[src], 0x00)
        "ldl        %[tmp0],    0x0f(%[StreamMedia])                        \n\t"
        "ldr        %[tmp0],    0x08(%[StreamMedia])                        \n\t"
        ...
        PTR_ADDU   "%[StreamMedia],     %[addr0],       %[srcstride]        \n\t"
        "sdl        %[tmp1],    0x0f(%[addr1])                      \n\t"
        "sdr        %[tmp1],    0x08(%[addr1])                      \n\t"
    ...
    for (i = 0; i < h; i++, dst += dststride, StreamMedia += srcstride)
        memcpy(dst, StreamMedia, 16);
#endif
}
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    /*
    dst[0] = cm[(filter[2] * StreamMedia[0] - filter[1] * StreamMedia[-1] + filter[3] * StreamMedia[1] - filter[4] * StreamMedia[2] + 64) >> 7];
    dst[1] = cm[(filter[2] * StreamMedia[1] - filter[1] * StreamMedia[ 0] + filter[3] * StreamMedia[2] - filter[4] * StreamMedia[3] + 64) >> 7];
    dst[2] = cm[(filter[2] * StreamMedia[2] - filter[1] * StreamMedia[ 1] + filter[3] * StreamMedia[3] - filter[4] * StreamMedia[4] + 64) >> 7];
    dst[3] = cm[(filter[2] * StreamMedia[3] - filter[1] * StreamMedia[ 2] + filter[3] * StreamMedia[4] - filter[4] * StreamMedia[5] + 64) >> 7];
    dst[4] = cm[(filter[2] * StreamMedia[4] - filter[1] * StreamMedia[ 3] + filter[3] * StreamMedia[5] - filter[4] * StreamMedia[6] + 64) >> 7];
    dst[5] = cm[(filter[2] * StreamMedia[5] - filter[1] * StreamMedia[ 4] + filter[3] * StreamMedia[6] - filter[4] * StreamMedia[7] + 64) >> 7];
    dst[6] = cm[(filter[2] * StreamMedia[6] - filter[1] * StreamMedia[ 5] + filter[3] * StreamMedia[7] - filter[4] * StreamMedia[8] + 64) >> 7];
    dst[7] = cm[(filter[2] * StreamMedia[7] - filter[1] * StreamMedia[ 6] + filter[3] * StreamMedia[8] - filter[4] * StreamMedia[9] + 64) >> 7];

    dst[ 8] = cm[(filter[2] * StreamMedia[ 8] - filter[1] * StreamMedia[ 7] + filter[3] * StreamMedia[ 9] - filter[4] * StreamMedia[10] + 64) >> 7];
    dst[ 9] = cm[(filter[2] * StreamMedia[ 9] - filter[1] * StreamMedia[ 8] + filter[3] * StreamMedia[10] - filter[4] * StreamMedia[11] + 64) >> 7];
    dst[10] = cm[(filter[2] * StreamMedia[10] - filter[1] * StreamMedia[ 9] + filter[3] * StreamMedia[11] - filter[4] * StreamMedia[12] + 64) >> 7];
    dst[11] = cm[(filter[2] * StreamMedia[11] - filter[1] * StreamMedia[10] + filter[3] * StreamMedia[12] - filter[4] * StreamMedia[13] + 64) >> 7];
    dst[12] = cm[(filter[2] * StreamMedia[12] - filter[1] * StreamMedia[11] + filter[3] * StreamMedia[13] - filter[4] * StreamMedia[14] + 64) >> 7];
    dst[13] = cm[(filter[2] * StreamMedia[13] - filter[1] * StreamMedia[12] + filter[3] * StreamMedia[14] - filter[4] * StreamMedia[15] + 64) >> 7];
    dst[14] = cm[(filter[2] * StreamMedia[14] - filter[1] * StreamMedia[13] + filter[3] * StreamMedia[15] - filter[4] * StreamMedia[16] + 64) >> 7];
    dst[15] = cm[(filter[2] * StreamMedia[15] - filter[1] * StreamMedia[14] + filter[3] * StreamMedia[16] - filter[4] * StreamMedia[17] + 64) >> 7];
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x07                                \n\t"
        ...
        PTR_ADDIU  "%[src1],    %[StreamMedia],         0x08                \n\t"
        PTR_ADDIU  "%[dst1],    %[dst],         0x08                \n\t"
        // 8 - 15
        PUT_VP8_EPEL8_H4_MMI(%[src1], %[dst1])

        "addiu      %[h],       %[h],           -0x01               \n\t"
        PTR_ADDU   "%[StreamMedia],     %[StreamMedia],         %[srcstride]        \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = FILTER_4TAP(StreamMedia, filter, 1);
        dst += dststride;
        StreamMedia += srcstride;
    }
#endif
}
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    /*
    dst[ 0] = cm[(filter[2]*StreamMedia[ 0] - filter[1]*StreamMedia[-1] + filter[0]*StreamMedia[-2] + filter[3]*StreamMedia[ 1] - filter[4]*StreamMedia[ 2] + filter[5]*StreamMedia[ 3] + 64) >> 7];
    dst[ 1] = cm[(filter[2]*StreamMedia[ 1] - filter[1]*StreamMedia[ 0] + filter[0]*StreamMedia[-1] + filter[3]*StreamMedia[ 2] - filter[4]*StreamMedia[ 3] + filter[5]*StreamMedia[ 4] + 64) >> 7];
    dst[ 2] = cm[(filter[2]*StreamMedia[ 2] - filter[1]*StreamMedia[ 1] + filter[0]*StreamMedia[ 0] + filter[3]*StreamMedia[ 3] - filter[4]*StreamMedia[ 4] + filter[5]*StreamMedia[ 5] + 64) >> 7];
    dst[ 3] = cm[(filter[2]*StreamMedia[ 3] - filter[1]*StreamMedia[ 2] + filter[0]*StreamMedia[ 1] + filter[3]*StreamMedia[ 4] - filter[4]*StreamMedia[ 5] + filter[5]*StreamMedia[ 6] + 64) >> 7];
    dst[ 4] = cm[(filter[2]*StreamMedia[ 4] - filter[1]*StreamMedia[ 3] + filter[0]*StreamMedia[ 2] + filter[3]*StreamMedia[ 5] - filter[4]*StreamMedia[ 6] + filter[5]*StreamMedia[ 7] + 64) >> 7];
    dst[ 5] = cm[(filter[2]*StreamMedia[ 5] - filter[1]*StreamMedia[ 4] + filter[0]*StreamMedia[ 3] + filter[3]*StreamMedia[ 6] - filter[4]*StreamMedia[ 7] + filter[5]*StreamMedia[ 8] + 64) >> 7];
    dst[ 6] = cm[(filter[2]*StreamMedia[ 6] - filter[1]*StreamMedia[ 5] + filter[0]*StreamMedia[ 4] + filter[3]*StreamMedia[ 7] - filter[4]*StreamMedia[ 8] + filter[5]*StreamMedia[ 9] + 64) >> 7];
    dst[ 7] = cm[(filter[2]*StreamMedia[ 7] - filter[1]*StreamMedia[ 6] + filter[0]*StreamMedia[ 5] + filter[3]*StreamMedia[ 8] - filter[4]*StreamMedia[ 9] + filter[5]*StreamMedia[10] + 64) >> 7];

    dst[ 8] = cm[(filter[2]*StreamMedia[ 8] - filter[1]*StreamMedia[ 7] + filter[0]*StreamMedia[ 6] + filter[3]*StreamMedia[ 9] - filter[4]*StreamMedia[10] + filter[5]*StreamMedia[11] + 64) >> 7];
    dst[ 9] = cm[(filter[2]*StreamMedia[ 9] - filter[1]*StreamMedia[ 8] + filter[0]*StreamMedia[ 7] + filter[3]*StreamMedia[10] - filter[4]*StreamMedia[11] + filter[5]*StreamMedia[12] + 64) >> 7];
    dst[10] = cm[(filter[2]*StreamMedia[10] - filter[1]*StreamMedia[ 9] + filter[0]*StreamMedia[ 8] + filter[3]*StreamMedia[11] - filter[4]*StreamMedia[12] + filter[5]*StreamMedia[13] + 64) >> 7];
    dst[11] = cm[(filter[2]*StreamMedia[11] - filter[1]*StreamMedia[10] + filter[0]*StreamMedia[ 9] + filter[3]*StreamMedia[12] - filter[4]*StreamMedia[13] + filter[5]*StreamMedia[14] + 64) >> 7];
    dst[12] = cm[(filter[2]*StreamMedia[12] - filter[1]*StreamMedia[11] + filter[0]*StreamMedia[10] + filter[3]*StreamMedia[13] - filter[4]*StreamMedia[14] + filter[5]*StreamMedia[15] + 64) >> 7];
    dst[13] = cm[(filter[2]*StreamMedia[13] - filter[1]*StreamMedia[12] + filter[0]*StreamMedia[11] + filter[3]*StreamMedia[14] - filter[4]*StreamMedia[15] + filter[5]*StreamMedia[16] + 64) >> 7];
    dst[14] = cm[(filter[2]*StreamMedia[14] - filter[1]*StreamMedia[13] + filter[0]*StreamMedia[12] + filter[3]*StreamMedia[15] - filter[4]*StreamMedia[16] + filter[5]*StreamMedia[17] + 64) >> 7];
    dst[15] = cm[(filter[2]*StreamMedia[15] - filter[1]*StreamMedia[14] + filter[0]*StreamMedia[13] + filter[3]*StreamMedia[16] - filter[4]*StreamMedia[17] + filter[5]*StreamMedia[18] + 64) >> 7];
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x07                                \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = FILTER_6TAP(StreamMedia, filter, 1);
        dst += dststride;
        StreamMedia += srcstride;
    }
#endif
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    /*
    dst[0] = cm[(filter[2] * StreamMedia[0] - filter[1] * StreamMedia[ -srcstride] + filter[3] * StreamMedia[  srcstride] - filter[4] * StreamMedia[  2*srcstride] + 64) >> 7];
    dst[1] = cm[(filter[2] * StreamMedia[1] - filter[1] * StreamMedia[1-srcstride] + filter[3] * StreamMedia[1+srcstride] - filter[4] * StreamMedia[1+2*srcstride] + 64) >> 7];
    dst[2] = cm[(filter[2] * StreamMedia[2] - filter[1] * StreamMedia[2-srcstride] + filter[3] * StreamMedia[2+srcstride] - filter[4] * StreamMedia[2+2*srcstride] + 64) >> 7];
    dst[3] = cm[(filter[2] * StreamMedia[3] - filter[1] * StreamMedia[3-srcstride] + filter[3] * StreamMedia[3+srcstride] - filter[4] * StreamMedia[3+2*srcstride] + 64) >> 7];
    dst[4] = cm[(filter[2] * StreamMedia[4] - filter[1] * StreamMedia[4-srcstride] + filter[3] * StreamMedia[4+srcstride] - filter[4] * StreamMedia[4+2*srcstride] + 64) >> 7];
    dst[5] = cm[(filter[2] * StreamMedia[5] - filter[1] * StreamMedia[5-srcstride] + filter[3] * StreamMedia[5+srcstride] - filter[4] * StreamMedia[5+2*srcstride] + 64) >> 7];
    dst[6] = cm[(filter[2] * StreamMedia[6] - filter[1] * StreamMedia[6-srcstride] + filter[3] * StreamMedia[6+srcstride] - filter[4] * StreamMedia[6+2*srcstride] + 64) >> 7];
    dst[7] = cm[(filter[2] * StreamMedia[7] - filter[1] * StreamMedia[7-srcstride] + filter[3] * StreamMedia[7+srcstride] - filter[4] * StreamMedia[7+2*srcstride] + 64) >> 7];

    dst[ 8] = cm[(filter[2] * StreamMedia[ 8] - filter[1] * StreamMedia[ 8-srcstride] + filter[3] * StreamMedia[ 8+srcstride] - filter[4] * StreamMedia[ 8+2*srcstride] + 64) >> 7];
    dst[ 9] = cm[(filter[2] * StreamMedia[ 9] - filter[1] * StreamMedia[ 9-srcstride] + filter[3] * StreamMedia[ 9+srcstride] - filter[4] * StreamMedia[ 9+2*srcstride] + 64) >> 7];
    dst[10] = cm[(filter[2] * StreamMedia[10] - filter[1] * StreamMedia[10-srcstride] + filter[3] * StreamMedia[10+srcstride] - filter[4] * StreamMedia[10+2*srcstride] + 64) >> 7];
    dst[11] = cm[(filter[2] * StreamMedia[11] - filter[1] * StreamMedia[11-srcstride] + filter[3] * StreamMedia[11+srcstride] - filter[4] * StreamMedia[11+2*srcstride] + 64) >> 7];
    dst[12] = cm[(filter[2] * StreamMedia[12] - filter[1] * StreamMedia[12-srcstride] + filter[3] * StreamMedia[12+srcstride] - filter[4] * StreamMedia[12+2*srcstride] + 64) >> 7];
    dst[13] = cm[(filter[2] * StreamMedia[13] - filter[1] * StreamMedia[13-srcstride] + filter[3] * StreamMedia[13+srcstride] - filter[4] * StreamMedia[13+2*srcstride] + 64) >> 7];
    dst[14] = cm[(filter[2] * StreamMedia[14] - filter[1] * StreamMedia[14-srcstride] + filter[3] * StreamMedia[14+srcstride] - filter[4] * StreamMedia[14+2*srcstride] + 64) >> 7];
    dst[15] = cm[(filter[2] * StreamMedia[15] - filter[1] * StreamMedia[15-srcstride] + filter[3] * StreamMedia[15+srcstride] - filter[4] * StreamMedia[15+2*srcstride] + 64) >> 7];
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x07                                \n\t"
        ...
        PTR_ADDIU  "%[src0],    %[StreamMedia],         0x08                \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = FILTER_4TAP(StreamMedia, filter, srcstride);
        dst += dststride;
        StreamMedia += srcstride;
    }
#endif
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    /*
    dst[0] = cm[(filter[2]*StreamMedia[0] - filter[1]*StreamMedia[0-srcstride] + filter[0]*StreamMedia[0-2*srcstride] + filter[3]*StreamMedia[0+srcstride] - filter[4]*StreamMedia[0+2*srcstride] + filter[5]*StreamMedia[0+3*srcstride] + 64) >> 7];
    dst[1] = cm[(filter[2]*StreamMedia[1] - filter[1]*StreamMedia[1-srcstride] + filter[0]*StreamMedia[1-2*srcstride] + filter[3]*StreamMedia[1+srcstride] - filter[4]*StreamMedia[1+2*srcstride] + filter[5]*StreamMedia[1+3*srcstride] + 64) >> 7];
    dst[2] = cm[(filter[2]*StreamMedia[2] - filter[1]*StreamMedia[2-srcstride] + filter[0]*StreamMedia[2-2*srcstride] + filter[3]*StreamMedia[2+srcstride] - filter[4]*StreamMedia[2+2*srcstride] + filter[5]*StreamMedia[2+3*srcstride] + 64) >> 7];
    dst[3] = cm[(filter[2]*StreamMedia[3] - filter[1]*StreamMedia[3-srcstride] + filter[0]*StreamMedia[3-2*srcstride] + filter[3]*StreamMedia[3+srcstride] - filter[4]*StreamMedia[3+2*srcstride] + filter[5]*StreamMedia[3+3*srcstride] + 64) >> 7];
    dst[4] = cm[(filter[2]*StreamMedia[4] - filter[1]*StreamMedia[4-srcstride] + filter[0]*StreamMedia[4-2*srcstride] + filter[3]*StreamMedia[4+srcstride] - filter[4]*StreamMedia[4+2*srcstride] + filter[5]*StreamMedia[4+3*srcstride] + 64) >> 7];
    dst[5] = cm[(filter[2]*StreamMedia[5] - filter[1]*StreamMedia[5-srcstride] + filter[0]*StreamMedia[5-2*srcstride] + filter[3]*StreamMedia[5+srcstride] - filter[4]*StreamMedia[5+2*srcstride] + filter[5]*StreamMedia[5+3*srcstride] + 64) >> 7];
    dst[6] = cm[(filter[2]*StreamMedia[6] - filter[1]*StreamMedia[6-srcstride] + filter[0]*StreamMedia[6-2*srcstride] + filter[3]*StreamMedia[6+srcstride] - filter[4]*StreamMedia[6+2*srcstride] + filter[5]*StreamMedia[6+3*srcstride] + 64) >> 7];
    dst[7] = cm[(filter[2]*StreamMedia[7] - filter[1]*StreamMedia[7-srcstride] + filter[0]*StreamMedia[7-2*srcstride] + filter[3]*StreamMedia[7+srcstride] - filter[4]*StreamMedia[7+2*srcstride] + filter[5]*StreamMedia[7+3*srcstride] + 64) >> 7];

    dst[ 8] = cm[(filter[2]*StreamMedia[ 8] - filter[1]*StreamMedia[ 8-srcstride] + filter[0]*StreamMedia[ 8-2*srcstride] + filter[3]*StreamMedia[ 8+srcstride] - filter[4]*StreamMedia[ 8+2*srcstride] + filter[5]*StreamMedia[ 8+3*srcstride] + 64) >> 7];
    dst[ 9] = cm[(filter[2]*StreamMedia[ 9] - filter[1]*StreamMedia[ 9-srcstride] + filter[0]*StreamMedia[ 9-2*srcstride] + filter[3]*StreamMedia[ 9+srcstride] - filter[4]*StreamMedia[ 9+2*srcstride] + filter[5]*StreamMedia[ 9+3*srcstride] + 64) >> 7];
    dst[10] = cm[(filter[2]*StreamMedia[10] - filter[1]*StreamMedia[10-srcstride] + filter[0]*StreamMedia[10-2*srcstride] + filter[3]*StreamMedia[10+srcstride] - filter[4]*StreamMedia[10+2*srcstride] + filter[5]*StreamMedia[10+3*srcstride] + 64) >> 7];
    dst[11] = cm[(filter[2]*StreamMedia[11] - filter[1]*StreamMedia[11-srcstride] + filter[0]*StreamMedia[11-2*srcstride] + filter[3]*StreamMedia[11+srcstride] - filter[4]*StreamMedia[11+2*srcstride] + filter[5]*StreamMedia[11+3*srcstride] + 64) >> 7];
    dst[12] = cm[(filter[2]*StreamMedia[12] - filter[1]*StreamMedia[12-srcstride] + filter[0]*StreamMedia[12-2*srcstride] + filter[3]*StreamMedia[12+srcstride] - filter[4]*StreamMedia[12+2*srcstride] + filter[5]*StreamMedia[12+3*srcstride] + 64) >> 7];
    dst[13] = cm[(filter[2]*StreamMedia[13] - filter[1]*StreamMedia[13-srcstride] + filter[0]*StreamMedia[13-2*srcstride] + filter[3]*StreamMedia[13+srcstride] - filter[4]*StreamMedia[13+2*srcstride] + filter[5]*StreamMedia[13+3*srcstride] + 64) >> 7];
    dst[14] = cm[(filter[2]*StreamMedia[14] - filter[1]*StreamMedia[14-srcstride] + filter[0]*StreamMedia[14-2*srcstride] + filter[3]*StreamMedia[14+srcstride] - filter[4]*StreamMedia[14+2*srcstride] + filter[5]*StreamMedia[14+3*srcstride] + 64) >> 7];
    dst[15] = cm[(filter[2]*StreamMedia[15] - filter[1]*StreamMedia[15-srcstride] + filter[0]*StreamMedia[15-2*srcstride] + filter[3]*StreamMedia[15+srcstride] - filter[4]*StreamMedia[15+2*srcstride] + filter[5]*StreamMedia[15+3*srcstride] + 64) >> 7];
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x07                                \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = FILTER_6TAP(StreamMedia, filter, srcstride);
        dst += dststride;
        StreamMedia += srcstride;
    }
#endif
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    for (y = 0; y < h + 3; y++) {
        for (x = 0; x < 16; x++)
            tmp[x] = FILTER_4TAP(StreamMedia, filter, 1);
        tmp += 16;
        StreamMedia += srcstride;
    }
        ...
        ptrdiff_t srcstride, int h, int mx, int my)
{
    ...
    for (y = 0; y < h + 3; y++) {
        for (x = 0; x < 16; x++)
            tmp[x] = FILTER_6TAP(StreamMedia, filter, 1);
        tmp += 16;
        StreamMedia += srcstride;
    }
        ...
        ptrdiff_t sstride, int h, int mx, int my)
{
    ...
    /*
    dst[0] = (a * StreamMedia[0] + b * StreamMedia[1] + 4) >> 3;
    dst[1] = (a * StreamMedia[1] + b * StreamMedia[2] + 4) >> 3;
    dst[2] = (a * StreamMedia[2] + b * StreamMedia[3] + 4) >> 3;
    dst[3] = (a * StreamMedia[3] + b * StreamMedia[4] + 4) >> 3;
    dst[4] = (a * StreamMedia[4] + b * StreamMedia[5] + 4) >> 3;
    dst[5] = (a * StreamMedia[5] + b * StreamMedia[6] + 4) >> 3;
    dst[6] = (a * StreamMedia[6] + b * StreamMedia[7] + 4) >> 3;
    dst[7] = (a * StreamMedia[7] + b * StreamMedia[8] + 4) >> 3;

    dst[ 8] = (a * StreamMedia[ 8] + b * StreamMedia[ 9] + 4) >> 3;
    dst[ 9] = (a * StreamMedia[ 9] + b * StreamMedia[10] + 4) >> 3;
    dst[10] = (a * StreamMedia[10] + b * StreamMedia[11] + 4) >> 3;
    dst[11] = (a * StreamMedia[11] + b * StreamMedia[12] + 4) >> 3;
    dst[12] = (a * StreamMedia[12] + b * StreamMedia[13] + 4) >> 3;
    dst[13] = (a * StreamMedia[13] + b * StreamMedia[14] + 4) >> 3;
    dst[14] = (a * StreamMedia[14] + b * StreamMedia[15] + 4) >> 3;
    dst[15] = (a * StreamMedia[15] + b * StreamMedia[16] + 4) >> 3;
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x03                                \n\t"
        ...
        "addiu      %[h],       %[h],           -0x01               \n\t"
        PTR_ADDU   "%[StreamMedia],     %[StreamMedia],         %[sstride]          \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = (a * StreamMedia[x] + b * StreamMedia[x + 1] + 4) >> 3;
        dst += dstride;
        StreamMedia += sstride;
    }
#endif
        ...
        ptrdiff_t sstride, int h, int mx, int my)
{
    ...
    /*
    dst[0] = (c * StreamMedia[0] + d * StreamMedia[    sstride] + 4) >> 3;
    dst[1] = (c * StreamMedia[1] + d * StreamMedia[1 + sstride] + 4) >> 3;
    dst[2] = (c * StreamMedia[2] + d * StreamMedia[2 + sstride] + 4) >> 3;
    dst[3] = (c * StreamMedia[3] + d * StreamMedia[3 + sstride] + 4) >> 3;
    dst[4] = (c * StreamMedia[4] + d * StreamMedia[4 + sstride] + 4) >> 3;
    dst[5] = (c * StreamMedia[5] + d * StreamMedia[5 + sstride] + 4) >> 3;
    dst[6] = (c * StreamMedia[6] + d * StreamMedia[6 + sstride] + 4) >> 3;
    dst[7] = (c * StreamMedia[7] + d * StreamMedia[7 + sstride] + 4) >> 3;
    */
    __asm__ volatile (
        "xor        %[ftmp0],   %[ftmp0],       %[ftmp0]            \n\t"
        "li         %[tmp0],    0x03                                \n\t"
    ...
    for (y = 0; y < h; y++) {
        for (x = 0; x < 16; x++)
            dst[x] = (c * StreamMedia[x] + d * StreamMedia[x + sstride] + 4) >> 3;
        dst += dstride;
        StreamMedia += sstride;
    }
#endif
        ...
        ptrdiff_t sstride, int h, int mx, int my)
{
    ...
    for (y = 0; y < h + 1; y++) {
        for (x = 0; x < 16; x++)
            tmp[x] = (a * StreamMedia[x] + b * StreamMedia[x + 1] + 4) >> 3;
        tmp += 16;
        StreamMedia += sstride;
    }
