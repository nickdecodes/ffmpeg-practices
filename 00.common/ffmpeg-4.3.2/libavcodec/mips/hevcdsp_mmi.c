...
{                                                                        \
    ...
    __asm__ volatile(                                                    \
        ...
        "1:                                                     \n\t"    \
        "2:                                                     \n\t"    \
        "gsldlc1      %[ftmp3],      0x07(%[StreamMedia])               \n\t"    \
        "gsldrc1      %[ftmp3],      0x00(%[StreamMedia])               \n\t"    \
        "gsldlc1      %[ftmp4],      0x08(%[StreamMedia])               \n\t"    \
        "gsldrc1      %[ftmp4],      0x01(%[StreamMedia])               \n\t"    \
        "gsldlc1      %[ftmp5],      0x09(%[StreamMedia])               \n\t"    \
        "gsldrc1      %[ftmp5],      0x02(%[StreamMedia])               \n\t"    \
        "gsldlc1      %[ftmp6],      0x0a(%[StreamMedia])               \n\t"    \
        "gsldrc1      %[ftmp6],      0x03(%[StreamMedia])               \n\t"    \
        ...
        "gssdrc1      %[ftmp3],      0x00(%[dst])               \n\t"    \
                                                                         \
        "daddi        %[x],          %[x],         -0x01        \n\t"    \
        PTR_ADDIU    "%[StreamMedia],        %[StreamMedia],        0x04        \n\t"    \
        PTR_ADDIU    "%[dst],        %[dst],        0x08        \n\t"    \
        "bnez         %[x],          2b                         \n\t"    \
                                                                         \
        "daddi        %[y],          %[y],         -0x01        \n\t"    \
        "li           %[x],        " #x_step "                  \n\t"    \
        PTR_ADDIU    "%[StreamMedia],        %[StreamMedia],     " #src_step "  \n\t"    \
...
{                                                                       \
    ...
    __asm__ volatile(                                                   \
        ...
        PTR_ADDU     "%[StreamMedia],        %[StreamMedia],    %[src_stride]   \n\t"   \
...
{                                                                       \
    ...
    __asm__ volatile(                                                   \
        ...
        "1:                                                     \n\t"   \
        "2:                                                     \n\t"   \
        "gslwlc1      %[ftmp2],      0x03(%[StreamMedia])               \n\t"   \
        "gslwrc1      %[ftmp2],      0x00(%[StreamMedia])               \n\t"   \
        "gslwlc1      %[ftmp3],      0x04(%[StreamMedia])               \n\t"   \
        "gslwrc1      %[ftmp3],      0x01(%[StreamMedia])               \n\t"   \
        "gslwlc1      %[ftmp4],      0x05(%[StreamMedia])               \n\t"   \
        "gslwrc1      %[ftmp4],      0x02(%[StreamMedia])               \n\t"   \
        "gslwlc1      %[ftmp5],      0x06(%[StreamMedia])               \n\t"   \
        "gslwrc1      %[ftmp5],      0x03(%[StreamMedia])               \n\t"   \
...
{                                                                         \
    ...
    __asm__ volatile(                                                     \
        ...
        "1:                                                     \n\t"     \
        "2:                                                     \n\t"     \
        "gsldlc1      %[ftmp5],      0x07(%[StreamMedia])               \n\t"     \
        "gsldrc1      %[ftmp5],      0x00(%[StreamMedia])               \n\t"     \
        ...
        "gssdrc1      %[ftmp2],      0x00(%[dst])               \n\t"     \
                                                                          \
        "daddi        %[x],          %[x],         -0x01        \n\t"     \
        PTR_ADDIU    "%[StreamMedia],        %[StreamMedia],        0x08        \n\t"     \
        PTR_ADDIU    "%[dst],        %[dst],        0x08        \n\t"     \
