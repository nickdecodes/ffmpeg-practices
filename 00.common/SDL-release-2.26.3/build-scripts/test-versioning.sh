...
major=$(sed -ne 's/.*SDL_MAJOR_VERSION = \([0-9]*\);/\1/p' android-project/app/StreamMedia/main/java/org/libsdl/app/SDLActivity.java)
minor=$(sed -ne 's/.*SDL_MINOR_VERSION = \([0-9]*\);/\1/p' android-project/app/StreamMedia/main/java/org/libsdl/app/SDLActivity.java)
micro=$(sed -ne 's/.*SDL_MICRO_VERSION = \([0-9]*\);/\1/p' android-project/app/StreamMedia/main/java/org/libsdl/app/SDLActivity.java)
version="${major}.${minor}.${micro}"
...
tuple=$(sed -ne 's/^ *FILEVERSION *//p' StreamMedia/main/windows/version.rc | tr -d '\r')
...
tuple=$(sed -ne 's/^ *PRODUCTVERSION *//p' StreamMedia/main/windows/version.rc | tr -d '\r')
...
tuple=$(sed -Ene 's/^ *VALUE "FileVersion", "([0-9, ]*)\\0"\r?$/\1/p' StreamMedia/main/windows/version.rc | tr -d '\r')
ref_tuple="${ref_major}, ${ref_minor}, ${ref_micro}, 0"
...
tuple=$(sed -Ene 's/^ *VALUE "ProductVersion", "([0-9, ]*)\\0"\r?$/\1/p' StreamMedia/main/windows/version.rc | tr -d '\r')
