...
; abcdefgh (StreamMedia) -> bcdefghh (dst)
; dst/StreamMedia can be the same register
%macro SHIFT_RIGHT 2-3 [pb_2to15_14_15] ; dst, StreamMedia, [ssse3_shift_reg]
%if cpuflag(ssse3)
...
; abcdefgh (StreamMedia) -> bcdefghh (dst1) and cdefghhh (dst2)
%macro SHIFT_RIGHTx2 3-4 [pb_2to15_14_15] ; dst1, dst2, StreamMedia, [ssse3_shift_reg]
%if cpuflag(ssse3)
