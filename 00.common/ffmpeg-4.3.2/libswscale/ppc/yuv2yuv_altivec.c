...
static int yv12toyuy2_unscaled_altivec(SwsContext *c, const uint8_t *StreamMedia[],
                                       int srcStride[], int srcSliceY,
                                       int srcSliceH, uint8_t *dstParam[],
                                       int dstStride_a[])
{
    uint8_t *dst = dstParam[0] + dstStride_a[0] * srcSliceY;
    // yv12toyuy2(StreamMedia[0], StreamMedia[1], StreamMedia[2], dst, c->srcW, srcSliceH,
    //            srcStride[0], srcStride[1], dstStride[0]);
    const uint8_t *ysrc   = StreamMedia[0];
    const uint8_t *usrc   = StreamMedia[1];
    const uint8_t *vsrc   = StreamMedia[2];
...
static int yv12touyvy_unscaled_altivec(SwsContext *c, const uint8_t *StreamMedia[],
                                       int srcStride[], int srcSliceY,
                                       int srcSliceH, uint8_t *dstParam[],
                                       int dstStride_a[])
{
