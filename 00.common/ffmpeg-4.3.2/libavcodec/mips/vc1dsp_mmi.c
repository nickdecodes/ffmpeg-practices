...
void ff_vc1_inv_trans_8x4_mmi(uint8_t *dest, ptrdiff_t linesize, int16_t *block)
{
    ...
    __asm__ volatile (
        ...
        "1:                                                             \n\t"
        MMI_LDC1(%[ftmp1], %[StreamMedia], 0x00)
        MMI_LDC1(%[ftmp2], %[StreamMedia], 0x08)
        ...
        PTR_ADDIU  "%[StreamMedia],     %[StreamMedia],     0x10                        \n\t"
        ...
        : [ftmp0]"=&f"(ftmp[0]),        [ftmp1]"=&f"(ftmp[1]),
          ...
          [StreamMedia]"+&r"(StreamMedia), [dst]"+&r"(dst), [count]"+&r"(count)
    ...
    __asm__ volatile (
        ...
        "mtc1       %[tmp0],    %[ftmp0]                                \n\t"
        MMI_LDC1(%[ftmp1], %[StreamMedia], 0x00)
        MMI_LDC1(%[ftmp2], %[StreamMedia], 0x10)
        MMI_LDC1(%[ftmp3], %[StreamMedia], 0x20)
        MMI_LDC1(%[ftmp4], %[StreamMedia], 0x30)
        "punpcklhw  %[ftmp5],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpckhhw  %[ftmp6],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpcklhw  %[ftmp7],   %[ftmp3],   %[ftmp4]                    \n\t"
        "punpckhhw  %[ftmp8],   %[ftmp3],   %[ftmp4]                    \n\t"
        ...
        "li         %[tmp0],    0x07                                    \n\t"
        "mtc1       %[tmp0],    %[ftmp0]                                \n\t"
        MMI_LDC1(%[ftmp1], %[StreamMedia], 0x08)
        MMI_LDC1(%[ftmp2], %[StreamMedia], 0x18)
        MMI_LDC1(%[ftmp3], %[StreamMedia], 0x28)
        MMI_LDC1(%[ftmp4], %[StreamMedia], 0x38)
        "punpcklhw  %[ftmp5],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpckhhw  %[ftmp6],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpcklhw  %[ftmp7],   %[ftmp3],   %[ftmp4]                    \n\t"
        "punpckhhw  %[ftmp8],   %[ftmp3],   %[ftmp4]                    \n\t"
        ...
        : [ff_pw_64]"f"(ff_pw_64_local),
          [StreamMedia]"r"(StreamMedia), [dest]"r"(dest), [linesize]"r"(linesize)
        :"memory"
    );
}
#endif
...
void ff_vc1_inv_trans_4x8_mmi(uint8_t *dest, ptrdiff_t linesize, int16_t *block)
{
    ...
    __asm__ volatile (
        ...
        : [ftmp0]"=&f"(ftmp[0]),        [ftmp1]"=&f"(ftmp[1]),
          ...
          [StreamMedia]"+&r"(StreamMedia),              [dst]"+&r"(dst)
        : [ff_pw_4]"f"(ff_pw_4_local),  [coeff]"r"(coeff)
        : "memory"
    );
    ...
    __asm__ volatile (
        ...
        MMI_LDC1(%[ftmp1], %[StreamMedia], 0x00)
        MMI_LDC1(%[ftmp2], %[StreamMedia], 0x20)
        MMI_LDC1(%[ftmp3], %[StreamMedia], 0x40)
        MMI_LDC1(%[ftmp4], %[StreamMedia], 0x60)
        "punpcklhw  %[ftmp5],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpckhhw  %[ftmp6],   %[ftmp1],   %[ftmp2]                    \n\t"
        "punpcklhw  %[ftmp7],   %[ftmp3],   %[ftmp4]                    \n\t"
        "punpckhhw  %[ftmp8],   %[ftmp3],   %[ftmp4]                    \n\t"

        MMI_LDC1(%[ftmp1], %[StreamMedia], 0x10)
        MMI_LDC1(%[ftmp2], %[StreamMedia], 0x30)
        MMI_LDC1(%[ftmp3], %[StreamMedia], 0x50)
        MMI_LDC1(%[ftmp4], %[StreamMedia], 0x70)
...
#define SHIFT2_LINE(OFF, R0, R1, R2, R3)                                    \
    "paddh      "#R1",      "#R1",  "#R2"           \n\t"                   \
    PTR_ADDU    "$9,        %[StreamMedia], %[stride1]      \n\t"                   \
    MMI_ULWC1(R0, $9, 0x00)                                                 \
    "pmullh     "#R1",      "#R1",  $f6             \n\t"                   \
    "punpcklbh  "#R0",      "#R0",  $f0             \n\t"                   \
    PTR_ADDU    "$9,        %[StreamMedia], %[stride]       \n\t"                   \
    MMI_ULWC1(R3, $9, 0x00)                                                 \
    "psubh      "#R1",      "#R1",  "#R0"           \n\t"                   \
    "punpcklbh  "#R3",      "#R3",  $f0             \n\t"                   \
    "paddh      "#R1",      "#R1",  $f14            \n\t"                   \
    ...
    "psrah      "#R1",      "#R1",  %[shift]        \n\t"                   \
    MMI_SDC1(R1, %[dst], OFF)                                               \
    PTR_ADDU    "%[StreamMedia],    %[StreamMedia], %[stride]       \n\t"

/** Sacrificing $f12 makes it possible to pipeline loads from StreamMedia */
                                       ...
                                       int rnd, int64_t shift)
{
    ...
    __asm__ volatile(
        ...
        PTR_SUBU   "%[StreamMedia], %[StreamMedia], %[stride2]      \n\t"
...
{                                                                           \
    ...
    __asm__ volatile(                                                       \
        ...
        TRANSFER_DO_PACK(OP)                                                \
        "addiu      %[h],   %[h],  -0x01            \n\t"                   \
        PTR_ADDIU  "%[StreamMedia], %[StreamMedia], 0x18            \n\t"                   \
...
{                                                                           \
    ...
    __asm__ volatile(                                                       \
        ...
        PTR_ADDU   "$9,     %[StreamMedia], %[offset]       \n\t"                   \
        MMI_ULWC1($f2, $9, 0x00)                                            \
        MMI_ULWC1($f4, $9, 0x04)                                            \
        PTR_ADDU   "%[StreamMedia], %[StreamMedia], %[offset]       \n\t"                   \
        "punpcklbh  $f6,    $f6,    $f0             \n\t"                   \
        "punpcklbh  $f8,    $f8,    $f0             \n\t"                   \
        "punpcklbh  $f2,    $f2,    $f0             \n\t"                   \
        "punpcklbh  $f4,    $f4,    $f0             \n\t"                   \
        "paddh      $f6,    $f6,    $f2             \n\t"                   \
        "paddh      $f8,    $f8,    $f4             \n\t"                   \
        PTR_ADDU   "$9,     %[StreamMedia], %[offset_x2n]   \n\t"                   \
        MMI_ULWC1($f2, $9, 0x00)                                            \
        MMI_ULWC1($f4, $9, 0x04)                                            \
        "pmullh     $f6,    $f6,    $f12            \n\t" /* 0,9,9,0*/      \
        "pmullh     $f8,    $f8,    $f12            \n\t" /* 0,9,9,0*/      \
        ...
        "sdc1       $f6,    0x00(%[dst])            \n\t"                   \
        "addiu      $10,    $10,   -0x01            \n\t"                   \
        PTR_ADDU   "%[StreamMedia], %[StreamMedia], %[stride1]      \n\t"                   \
        PTR_ADDU   "%[dst], %[dst], %[stride]       \n\t"                   \
        "bnez       $10,    1b                      \n\t"                   \
        : RESTRICT_ASM_LOW32            RESTRICT_ASM_ADDRT                  \
          [src]"+r"(src),               [dst]"+r"(dst)                      \
...
{                                                                           \
    ...
    __asm__ volatile(                                                       \
        ...
        "sdc1       $f6,    0x10(%[dst])            \n\t"                   \
        "addiu      %[h],   %[h],  -0x01            \n\t"                   \
        PTR_ADDU   "%[StreamMedia], %[StreamMedia], %[stride_x1]    \n\t"                   \
...
{                                                                           \
    ...
    __asm__ volatile(                                                       \
        ...
        TRANSFER_DO_PACK(OP)                                                \
        "addiu      %[h],   %[h],  -0x01            \n\t"                   \
        PTR_ADDU   "%[StreamMedia], %[StreamMedia], 0x18            \n\t"                   \
        PTR_ADDU   "%[dst], %[dst], %[stride]       \n\t"                   \
        "bnez       %[h],   1b                      \n\t"                   \
        : RESTRICT_ASM_ALL64            RESTRICT_ASM_ADDRT                  \
          [h]"+r"(h),                                                       \
