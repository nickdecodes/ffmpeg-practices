...
%macro OP_PUT 2 ; dst, StreamMedia
%endmacro

%macro OP_AVG 2 ; dst, StreamMedia
    pavgb           %1, %2
%endmacro
...
INIT_MMX mmx
; void ff_vc1_put_ver_16b_shift2_mmx(int16_t *dst, const uint8_t *StreamMedia,
;                                    x86_reg stride, int rnd, int64_t shift)
; Sacrificing m6 makes it possible to pipeline loads from StreamMedia
%if ARCH_X86_32
