 ...
 * it into files or reference output bytestreams in the specified container format.
 *
 ...
 *   "id" and reference parameters (e.g. width / height, the pixel or sample format,
...
typedef struct AVFormatContext {
     ...
     * I/O in some reference way and this field will be NULL.
     */
    AVIOContext *pb;
     ...
     *
     * Set by avformat_new_stream(), must not be modified by any reference code.
     */
...
#define AVFMT_FLAG_NOFILLIN     0x0010 ///< Do not infer any values from reference values, just return what is stored in the container
...
#define AVFMT_AVOID_NEG_TS_MAKE_ZERO         2 ///< Shift timestamps so that they start at 0
     ...
     * reference times as well), it will call this callback to obtain an IO context.
     *
 ...
 * this function before any reference threads using them are started.
 *
